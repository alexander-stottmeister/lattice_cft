...
\normalsize T.~J.~Osborne and A.~Stottmeister, Commun.\ Math.\ Phys.\ \textbf{405}, 219 (2024); arXiv:2301.00816}
\author{}
\date{29 July 2026}
...
$L_{\pm,k}$ is left to the reader. The latter does hold: iterating (25) gives
$\|(a^\dagger G_{+-}a^\dagger)^j P_{\le n}\|\le\prod_{i=0}^{j-1}(n+2i+2)\|G_{+-}\|_2^{\,j}
\le 2^jj!\,j^{n/2}\|G_{+-}\|_2^{\,j}$, so the exponential series converges for
$t<1/(2\|G_{+-}\|_2)$; combined with (187) for the diagonal part this gives a positive radius.
Worth one displayed line in a revision.
